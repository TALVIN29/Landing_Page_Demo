...
import { a as joinRelativeURL, b as useRuntimeConfig, c as getResponseStatusText, d as getResponseStatus, e as defineRenderHandler, f as getQuery, h as createError, i as getRouteRules, k as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Professional packaging automation solutions for medical devices, pharmaceuticals, glove manufacturing, and FMCG industries."},{"name":"keywords","content":"packaging automation, medical devices, pharmaceuticals, glove manufacturing, FMCG, Malaysia"},{"name":"author","content":"Packaging Automation Solutions"},{"property":"og:title","content":"Packaging Automation Solutions"},{"property":"og:description","content":"Professional packaging automation solutions for medical devices, pharmaceuticals, glove manufacturing, and FMCG industries."},{"property":"og:type","content":"website"},{"name":"twitter:card","content":"summary_large_image"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Packaging Automation Solutions"};
