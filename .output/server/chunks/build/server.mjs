import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, mergeProps, createVNode, resolveDynamicComponent, hasInjectionContext, inject, getCurrentInstance, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, withCtx, createTextVNode, onErrorCaptured, onServerPrefetch, reactive, effectScope, nextTick, getCurrentScope, toRef, isReadonly, toRaw, isRef, isShallow, isReactive, Text } from 'vue';
import { l as sanitizeStatusCode, m as getContext, $ as $fetch, n as createHooks, h as createError$1, o as defu, p as executeAsync, q as getHeader, r as setCookie, v as getRequestProtocol, w as klona, x as getRequestHeaders, y as getRequestHeader, d as destr, z as isEqual$1, A as getCookie, B as deleteCookie } from '../_/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    ...
    component: () => import('./test-DFQc8w_Q.mjs')
  },
  {
    name: "test___ms",
    path: "/ms/test",
  ...
  },
  {
    name: "about___en",
    path: "/about",
    component: () => import('./about-FlYMObmp.mjs')
  },
  {
    name: "about___ms",
    path: "/ms/about",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-Dal7MB0N.mjs')
  },
  {
    name: "index___ms",
    path: "/ms",
  ...
  },
  {
    name: "terms___en",
    path: "/terms",
    component: () => import('./terms-C98Y0tvy.mjs')
  },
  {
    name: "terms___ms",
    path: "/ms/terms",
  ...
  },
  {
    name: "contact___en",
    path: "/contact",
    component: () => import('./contact-C8Sq8Xe9.mjs')
  },
  {
    name: "contact___ms",
    path: "/ms/contact",
  ...
  },
  {
    name: "privacy___en",
    path: "/privacy",
    component: () => import('./privacy-DioApZ4m.mjs')
  },
  {
    name: "privacy___ms",
    path: "/ms/privacy",
  ...
  },
  {
    name: "products___en",
    path: "/products",
    component: () => import('./products-Bbq6zida.mjs')
  },
  {
    name: "products___ms",
    path: "/ms/products",
  ...
  },
  {
    name: "projects___en",
    path: "/projects",
    component: () => import('./projects-C_b3D-pq.mjs')
  },
  {
    name: "projects___ms",
    path: "/ms/projects",
  ...
  },
  {
    name: "services___en",
    path: "/services",
    component: () => import('./services-CWRlQAmF.mjs')
  },
  {
    name: "services___ms",
    path: "/ms/services",
  ...
  },
  {
    name: "investors___en",
    path: "/investors",
    component: () => import('./investors-BTXwPCoG.mjs')
  },
  {
    name: "investors___ms",
    path: "/ms/investors",
  ...
  },
  {
    name: "blog___en",
    path: "/blog",
    component: () => import('./index-BlqYDZC7.mjs')
  },
  {
    name: "blog___ms",
    path: "/ms/blog",
  ...
  },
  {
    name: "blog-slug___en",
    path: "/blog/:slug()",
    component: () => import('./_slug_-C75yw27u.mjs')
  },
  {
    name: "blog-slug___ms",
    path: "/ms/blog/:slug()",
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_82e76a9b",
      load: () => import(
        './en-CZYUiC7e.mjs'
        /* webpackChunkName: "locale_en_46json_82e76a9b" */
      ),
      cache: true
    }
  ],
  ms: [
    {
      key: "locale_ms_46json_3c9f98cc",
      load: () => import(
        './ms-BjT1GUI0.mjs'
        /* webpackChunkName: "locale_ms_46json_3c9f98cc" */
      ),
      cache: true
    }
  ],
  zh: [
    {
      key: "locale_zh_46json_bd403d42",
      load: () => import(
        './zh-BSJRWNaV.mjs'
        /* webpackChunkName: "locale_zh_46json_bd403d42" */
      ),
      cache: true
    }
  ]
...
const normalizedLocales = [
  {
    ...
    files: [
      {
        path: "E:/Vibe_Coding/Open_Code/frontend/i18n/en.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "E:/Vibe_Coding/Open_Code/frontend/i18n/ms.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "E:/Vibe_Coding/Open_Code/frontend/i18n/zh.json",
        cache: void 0
      }
    ]
  }
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CU8Skj-M.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.leftIcon && !__props.loading) {
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(__props.leftIcon), { class: "mr-2 -ml-1 h-4 w-4" }, null), _parent);
      } else {
        _push(`<!---->`);
      }
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      if (__props.rightIcon) {
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(__props.rightIcon), { class: "ml-2 -mr-1 h-4 w-4" }, null), _parent);
      } else {
        _push(`<!---->`);
      }
      _push(`</button>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-secondary-900 to-primary-900 flex items-center justify-center px-4" }, _attrs))}><div class="max-w-2xl w-full text-center"><div class="mb-8"><h1 class="text-[150px] sm:text-[200px] font-bold text-white/20 leading-none">${ssrInterpolate(__props.error.statusCode)}</h1></div><div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 sm:p-12"><h2 class="text-3xl sm:text-4xl font-bold text-white mb-4">${ssrInterpolate(unref(errorTitle))}</h2><p class="text-primary-100 text-lg mb-8 max-w-lg mx-auto">${ssrInterpolate(unref(errorMessage))}</p><div class="flex flex-col sm:flex-row gap-4 justify-center">`);
      ...
      _push(`</div></div><div class="mt-12 text-primary-100"><p class="mb-4">Need help? Contact us:</p><div class="flex flex-col sm:flex-row gap-4 justify-center text-sm"><a href="mailto:support@packagingautomation.com" class="hover:text-white transition-colors"> support@packagingautomation.com </a><span class="hidden sm:inline">|</span><a href="tel:+60312345678" class="hover:text-white transition-colors"> +60 3 1234 5678 </a></div></div></div></div>`);
    };
  }
});
...
export { _sfc_main$2 as _, useNuxtApp as a, useRoute as b, useRouter as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, withoutTrailingSlash as f, nuxtLinkDefaults as g, hasProtocol as h, joinURL as j, navigateTo as n, parseQuery as p, resolveRouteObject$1 as r, useHead as u, withTrailingSlash as w };
